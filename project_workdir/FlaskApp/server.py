...
#    game_same_pubs = sql_readaspd(sqlurl,publisher_query(game_info['Publishers'].values[0]))
    ...
    #Slightly hacky way of including variable number of games in a single HTML file but cleaner than trying to force Flask to do it using variables
    ...
    #Same process as above but for game developers instead of publishers. Need to convert this into a function according to the DRY rule.
